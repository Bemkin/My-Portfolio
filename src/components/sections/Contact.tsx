    ...
    return (
        <article className={`contact ${active ? 'active' : ''}`} data-page="contact">
            ...
            <motion.section
                ...
                style={{ borderRadius: '20px', overflow: 'hidden', marginBottom: '30px', border: '1px solid var(--glass-border)' }}
            >
                <figure>
                    <iframe
                        ...
                        width="100%" height="300" loading="lazy" referrerPolicy="no-referrer-when-downgrade" style={{ filter: 'grayscale(1) invert(1) opacity(0.6)' }}></iframe>
                </figure>
            </motion.section>
